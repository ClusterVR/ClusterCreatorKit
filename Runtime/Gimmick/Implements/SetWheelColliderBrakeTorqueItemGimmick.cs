...
namespace ClusterVR.CreatorKit.Gimmick.Implements
{
    ...
    public sealed class SetWheelColliderBrakeTorqueItemGimmick : MonoBehaviour, IItemGimmick
    {
        ...
        {
            currentTorque = GetValue(value) * power;
        }
        ...
        void FixedUpdate()
        {
            foreach (var wheelCollider in wheelColliders)
            {
                ...
                wheelCollider.brakeTorque = currentTorque;
            }
        }
