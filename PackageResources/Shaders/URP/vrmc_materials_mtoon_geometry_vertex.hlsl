// Original source:
//   https://github.com/vrm-c/UniVRM/blob/v0.129.1/Assets/VRM10/MToon10/Shaders/vrmc_materials_mtoon_geometry_vertex.hlsl
...
inline half MToon_GetOutlineVertex_OutlineWidth(const float2 uv)
{
    if (MToon_IsParameterMapOn())
    {
        ...
        return _OutlineWidth * UNITY_SAMPLE_TEX2D_LOD(_OutlineWidthTexture, uv, 0).g;
    }
    else
    {
