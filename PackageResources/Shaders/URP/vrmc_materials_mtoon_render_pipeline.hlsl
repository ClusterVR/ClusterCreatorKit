// Original source:
//   https://github.com/vrm-c/UniVRM/blob/v0.129.1/Assets/VRM10/MToon10/Shaders/vrmc_materials_mtoon_render_pipeline.hlsl
...
#define MTOON_TRANSFER_FOG_AND_LIGHTING(o, outpos, coord, vertex) \
    OUTPUT_LIGHTMAP_UV(coord.xy, unity_LightmapST, o.lightmapUV); \
    OUTPUT_SH(o.normalWS.xyz, o.vertexSH); \
    o.fogFactorAndVertexLight = half4(ComputeFogFactor(outpos.z), VertexLighting(o.positionWS, o.normalWS)); \
    o.shadowCoord = GetShadowCoord(GetVertexPositionInputs(vertex.xyz)); 
#else
#define MTOON_TRANSFER_FOG_AND_LIGHTING(o, outpos, coord, vertex) \
    OUTPUT_LIGHTMAP_UV(coord.xy, unity_LightmapST, o.lightmapUV); \
    OUTPUT_SH(o.normalWS.xyz, o.vertexSH); \
