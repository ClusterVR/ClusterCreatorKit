...
namespace ClusterVR.CreatorKit.Editor.Window.View
{
    public class AboutWindow : EditorWindow
    {
        ...
        {
            if (EditorPrefsUtils.HasAlreadyShownAboutWindow) return;
            ShowWindow();
        ...
        static VisualElement CreateView()
        {
            ...
            view.Query<Button>("open-document").ForEach(b => b.clickable.clicked += () => Application.OpenURL("https://clustervr.gitbook.io/creatorkit/"));
            view.Query<Button>("open-creators-guide").ForEach(b => b.clickable.clicked += () => Application.OpenURL("https://creator.cluster.mu/"));
