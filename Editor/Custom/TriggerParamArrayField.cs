...
{
    public static class TriggerParamArrayField
    {
        public static VisualElement CreateTriggerParamArrayField(SerializedProperty serializedProperty)
        {
            Assert.IsTrue(serializedProperty.isArray);
            Assert.AreEqual(serializedProperty.arrayElementType, nameof(TriggerParam));
