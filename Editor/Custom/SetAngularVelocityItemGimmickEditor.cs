...
{
    [CustomEditor(typeof(SetAngularVelocityItemGimmick), isFallback = true), CanEditMultipleObjects]
    public class SetAngularVelocityItemGimmickEditor : UnityEditor.Editor
    {
